    ...
    onSuccess: async (ctx, text) => {
      ...
      for (const line of lines) {
        ...
        if (parts.length >= 6) {
          ...
          // Encontra ou cria produto pelo nome
      ...
      await ctx.editMessage('✅ Logins adicionados com sucesso.');
